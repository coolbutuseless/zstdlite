...
`zstd_compress()` and `zstd_decompress()` can be used when you have raw data
compressed elsewhere, or want to make compressed data available to other systems in a 
cross-platform way.
