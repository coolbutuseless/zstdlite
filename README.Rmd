...
mechanism, they will save/load (almost) any R object, not just data.frames (Note: currently reference objects, 
...
# Create a dictionary
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
dict <- zstd_train_dict_serialize(train_samples, size = 1200, optim = TRUE)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
s0 <- lapply(test_samples, \(x)      serialize(x, NULL              )) |> lengths() |> sum()
...
cat("Compression ratio without dictinary:", round(s0/s1, 1), "\n")
