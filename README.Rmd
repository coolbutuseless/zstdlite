...
This is mainly an exploratory package figuring out some of R internals, but 
it does compress data, and it is pretty fast.
...
[zstd](https://github.com/facebook/zstd) code provided with this package is v1.4.6.
