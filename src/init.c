...
extern SEXP zstd_serialize_(SEXP robj_, SEXP level_, SEXP num_threads_);
extern SEXP zstd_unserialize_(SEXP raw_vec_);

extern SEXP zstd_serialize_stream_(SEXP robj_, SEXP level_, SEXP num_threads_);

extern SEXP zstd_compress_(SEXP raw_vec_, SEXP level_, SEXP num_threads_);
...
static const R_CallMethodDef CEntries[] = {
  {"zstd_serialize_"       , (DL_FUNC) &zstd_serialize_       , 3},
