...
extern SEXP zstd_compress_stream_file_(SEXP robj_, SEXP file_, SEXP cctx_, SEXP opts_);
extern SEXP zstd_decompress_stream_file_(SEXP raw_vec_, SEXP type_, SEXP dctx_, SEXP opts_);

extern SEXP zstd_compress_conn_  (SEXP vec_, SEXP conn_, SEXP cctx_, SEXP opts_);
extern SEXP zstd_decompress_conn_(SEXP conn_, SEXP type_, SEXP cctx_, SEXP opts_);
...
extern SEXP zstd_serialize_stream_file_(SEXP robj_, SEXP file_, SEXP cctx_, SEXP opts_);
extern SEXP zstd_unserialize_stream_file_(SEXP raw_vec_, SEXP dctx_, SEXP opts_);

extern SEXP zstd_serialize_conn_(SEXP robj_, SEXP conn_, SEXP cctx_, SEXP opts_);
extern SEXP zstd_unserialize_conn_(SEXP conn_, SEXP dctx_, SEXP opts_);

extern SEXP zstd_serialize_stream_(SEXP robj_, SEXP cctx_, SEXP opts_);
...
static const R_CallMethodDef CEntries[] = {
  ...
  {"zstd_compress_conn_"          , (DL_FUNC) &zstd_compress_conn_          , 4},
  {"zstd_decompress_conn_"        , (DL_FUNC) &zstd_decompress_conn_        , 4},
  ...
  {"zstd_serialize_conn_"         , (DL_FUNC) &zstd_serialize_conn_          , 4},
  {"zstd_unserialize_conn_"       , (DL_FUNC) &zstd_unserialize_conn_       , 3},
